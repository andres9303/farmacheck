...
return new class extends Migration
{
    ...
    {
        Schema::create('physicochemical_interactions', function (Blueprint $table) {
            $table->id();
            ...
            $table->text('consequences')->nullable()->comment('Consecuencias de la interacción');
            ...
            $table->unique(['medication_1_id', 'medication_2_id'], 'unique_medication_pair');
    ...
    {
        Schema::dropIfExists('physicochemical_interactions');
    }
};
