...
/**
 * Modelo para gestionar las interacciones farmacocinéticas entre medicamentos
 * Almacena información sobre efectos en la absorción, distribución, metabolismo y eliminación
 */
class PharmacokineticInteraction extends Model
{
    /**
    ...
    protected $fillable = [
        ...
        'process_affected',       // Proceso farmacocinético afectado (ADME)
    ...
    /**
     * Filtra una consulta por proceso farmacocinético afectado
     * Busca interacciones que afectan un proceso específico
     */
    public function scopeOfProcess($query, $process)
    {
        return $query->where('process_affected', $process);
    }
