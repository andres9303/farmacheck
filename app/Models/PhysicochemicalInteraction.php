...
/**
 * Modelo para gestionar las interacciones fisicoquímicas entre medicamentos
 * Almacena información sobre incompatibilidades químicas y físicas
 */
class PhysicochemicalInteraction extends Model
{
    /**
    ...
    protected $fillable = [
        ...
        'consequences',           // Consecuencias clínicas de la interacción
